namespace AssociateTestsToTestCases.Message.Association
{
    ...
    {
        public readonly string TestCaseInfo = "Test Case '{0}' (Test Case Id: {1})";
        ...
        public readonly string TestCaseWithNotAvailableTestMethod = "Test Case '{0}' (Test Case Id: {1}) (Test Method: {2})";
    }
}
