namespace AssociateTestsToTestCases.Message
{
    ...
    public class DllTestMethodsMessage
    {
        ...
        public readonly string Success = "DLL Test Methods have been obtained.\n";
    ...
    public class TestCasesMessage
    {
        ...
        public readonly string Success = "Azure DevOps Test Cases have been obtained.\n";
    ...
    public class AssociationMessage
    {
        ...
        public readonly string Success = "Test Cases and Test Methods have been associated.\n";
    }

    public class SummaryMessage
    {
        public readonly string Status = "Summary:";
        public readonly string Overview = "Total Azure DevOps Test Cases: {0} | Total Automated Test Cases: {1}";
