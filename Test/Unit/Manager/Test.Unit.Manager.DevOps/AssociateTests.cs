...
namespace Test.Unit.Manager.DevOps
{
    ...
    public class AssociateTests
    {
        ...
        public void Program_Associate_TestMethodsAssociationErrorCountIsNotEqualToZero()
        {
            ...
            outputAccessMock.Verify(x => x.WriteToConsole(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Exactly(2));
        }
        ...
        public void Program_Associate_Success()
        {
            ...
            var target = new DevOpsManagerFactory(devOpsAccessMock.Object, outputManagerMock.Object, outputAccess.Object, testCaseAccessMock.Object, counter, messages).Create();
